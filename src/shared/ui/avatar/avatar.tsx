...
/**
 ...
 - Возвращается корневой элемент div с примененными классами и стилями. Внутри него расположен компонент AvatarRadix.Root,
 представляющий базовый контейнер аватара.
 - Внутри AvatarRadix.Root расположены компоненты:
