...
export const LogoutIcon = (allProps: IconProps) => {
    ...
    return (
        <IconWrapper
            // значение иконки - как ее видим
            icon={
                <svg
                    fill={'currentColor'} // цвет иконки
                    height={'100%'}
                    viewBox={'0 0 16 16'} // определяет размеры видимой области (вьюпорта) в 16 пикселей по обеим осям
                    width={'100%'}
                    xmlns={'http://www.w3.org/2000/svg'} // Этот атрибут гарантирует, что браузер или парсер знает, что содержимое <svg> следует интерпретировать как SVG-графику
                    {...props}
                >
                    <path
                        d={
